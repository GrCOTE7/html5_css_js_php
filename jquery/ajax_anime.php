...
//        while (i < 10) {
        ...
        $('#majPremier').click(function() {
          ...
          $('#premier').fadeTo(3000, 0);
          $('#majPremier').fadeTo(2000, 0);


          setTimeout(function() {
            $('#premier').load('ajax_anime_incl.html #modif1', function() {
              Notifier.success('Par AJAX', 'La première zone a été mise à jour');

              $('#premier').css('transition', 'none');
              $('#premier').fadeTo(3000, 1);
              $('#majPremier').fadeTo(2000, 0);
        ...
        var eventClicOnBytnOrChat = function() {
          ...
          if (clickPossible == 1) {
            ...
            clickPossible = 0;
            $('#deuxieme').load('ajax_anime_incl.html #modif2', function() {
